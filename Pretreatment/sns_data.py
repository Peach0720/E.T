...
table = sqlalchemy.Table('sns', metadata, autoload=True, autoload_with=engine)          #테이블 명

print(table.columns.keys())
indata=[]
###query = sqlalchemy.select([table])
query = sqlalchemy.select(table.c.제목,table.c.날짜,table.c.Ticker).where(
    table.c.날짜 >= '2021.07.01', table.c.날짜 <= '2021.12.31', table.c.Ticker != '05930', table.c.Ticker != '000660' )
print(query)
